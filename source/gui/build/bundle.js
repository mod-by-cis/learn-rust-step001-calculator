...
function re(_, e, t, r2, l2, n, i, u, f, s, p2) {
  var o2, v2, c2, m, g2, y2, h, a = r2 && r2.__k || ne, w2 = e.length;
  for (f = ae(t, e, a, f, w2), o2 = 0; o2 < w2; o2++) (c2 = t.__k[o2]) != null && (v2 = c2.__i == -1 ? M : a[c2.__i] || M, c2.__i = o2, y2 = q(_, c2, v2, l2, n, i, u, f, s, p2), m = c2.__e, c2.ref && v2.ref != c2.ref && (v2.ref && G(v2.ref, null, c2), p2.push(c2.ref, c2.__c || m, c2)), g2 == null && m != null && (g2 = m), (h = !!(4 & c2.__u)) || v2.__k === c2.__k ? f = le(c2, f, _, h) : typeof c2.type == "function" && y2 !== void 0 ? f = y2 : m && (f = m.nextSibling), c2.__u &= -7);
  return t.__e = g2, f;
}
...
function q(_, e, t, r2, l2, n, i, u, f, s) {
  var p2, o2, v2, c2, m, g2, y2, h, a, w2, x2, W2, U2, J, A2, T, R, b2 = e.type;
  if (e.constructor !== void 0) return null;
  128 & t.__u && (f = !!(32 & t.__u), n = [
    u = e.__e = t.__e
  ]), (p2 = d.__b) && p2(e);
  e: if (typeof b2 == "function") try {
    if (h = e.props, a = "prototype" in b2 && b2.prototype.render, w2 = (p2 = b2.contextType) && r2[p2.__c], x2 = p2 ? w2 ? w2.props.value : p2.__ : r2, t.__c ? y2 = (o2 = e.__c = t.__c).__ = o2.__E : (a ? e.__c = o2 = new b2(h, x2) : (e.__c = o2 = new N(h, x2), o2.constructor = b2, o2.render = me), w2 && w2.sub(o2), o2.state || (o2.state = {}), o2.__n = r2, v2 = o2.__d = true, o2.__h = [], o2._sb = []), a && o2.__s == null && (o2.__s = o2.state), a && b2.getDerivedStateFromProps != null && (o2.__s == o2.state && (o2.__s = k({}, o2.__s)), k(o2.__s, b2.getDerivedStateFromProps(h, o2.__s))), c2 = o2.props, m = o2.state, o2.__v = e, v2) a && b2.getDerivedStateFromProps == null && o2.componentWillMount != null && o2.componentWillMount(), a && o2.componentDidMount != null && o2.__h.push(o2.componentDidMount);
    else {
    ...
    o2.state = o2.__s, o2.getChildContext != null && (r2 = k(k({}, r2), o2.getChildContext())), a && !v2 && o2.getSnapshotBeforeUpdate != null && (g2 = o2.getSnapshotBeforeUpdate(c2, m)), T = p2, p2 != null && p2.type === I && p2.key == null && (T = se(p2.props.children)), u = re(_, L(T) ? T : [
      T
    ], e, t, r2, l2, n, i, u, f, s), o2.base = e.__e, e.__u &= -161, o2.__h.length && i.push(o2), y2 && (o2.__E = o2.__ = null);
  } catch (P) {
...
function ve(_, e, t, r2, l2, n, i, u, f) {
  var s, p2, o2, v2, c2, m, g2, y2 = t.props || M, h = e.props, a = e.type;
  ...
  if (a == null) y2 === h || u && _.data == h || (_.data = h);
  else {
    if (n = n && D.call(_.childNodes), !u && n != null) for (y2 = {}, s = 0; s < _.attributes.length; s++) y2[(c2 = _.attributes[s]).name] = c2.value;
    for (s in y2) if (c2 = y2[s], s != "children") {
    ...
    for (s in h) c2 = h[s], s == "children" ? v2 = c2 : s == "dangerouslySetInnerHTML" ? p2 = c2 : s == "value" ? m = c2 : s == "checked" ? g2 = c2 : u && typeof c2 != "function" || y2[s] === c2 || F(_, s, c2, y2[s], l2);
    ...
    u || (s = "value", a == "progress" && m == null ? _.removeAttribute("value") : m != null && (m !== _[s] || a == "progress" && !m || a == "option" && m != y2[s]) && F(_, s, m, y2[s], l2), s = "checked", g2 != null && g2 != _[s] && F(_, s, g2, y2[s], l2));
  }
  return _;
}
function G(_, e, t) {
...
function App() {
  ...
  w(() => {
    invoke("get_initial_value").then((val) => setDisplay(val.toString())).catch((err) => console.error("B\u0142\u0105d synchronizacji:", err));
  }, []);
  const runCalculation = async (a, b2, op) => {
    try {
      const res = await invoke("oblicz_tauri", {
        a,
        b: b2,
        op
      });
  ...
  w(() => {
    const onKeyDown = (e) => {
      ...
      if ([
        ...
        "*",
        "/"
      ].includes(e.key)) handleOperator(e.key);
      if (e.key === "Enter" || e.key === "=") performEquals();
      if (e.key === "Escape") setDisplay("0");
      if (e.key === "Backspace") setDisplay((d3) => d3.length > 1 ? d3.slice(0, -1) : "0");
  ...
  return fe("div", {
    ...
    fe("div", {
      ...
      // Wiersz 1
      fe("button", {
        style: specBtn + " grid-column: span 3;",
      ...
      // Wiersz 5
      fe("button", {
        style: numBtn + " grid-column: span 2;",
